...
return [
    ...
    'restore_confirm'       => 'Вы уверены, что хотите восстановить?',
    'restore_succeeded'     => 'Успешно восстановлено!',
    'restore_failed'        => 'Ошибка восстановления!',
    'batch_restore'         => 'Пакетное восстановление',
    ...
    'choices'               => [
        ...
        'uniqueItemText'        => 'Можно выбрать только уникальные значения',
        'customAddItemText'     => 'Можно выбрать только значения, соответствующие определенным условиям.',
    ],
];
